            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-6 sm:mb-8">
                <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold leading-tight">
                  ...
                  <span className="relative inline-block">
                    I'm
                    <span className="typing-effect gradient-text"> Ashik</span>
                  </span>
                </h1>
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  A person who wants to make journeys into the music and silence
                  of the heart..
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  target="_blank"
                  href="https://drive.google.com/file/d/18Zxq3EfgipVwGuup8naT47GsHnpZjRTN/view?usp=sharing"
